            ...
            <div class="container">
               <div class="containt_main">
                  <div id="mySidenav" class="sidenav">
                     ...
                     <a href="{{url('http://localhost:8000/Home')}}">Home</a>
                     <a href="{{url('fashion')}}">Fashion</a>
                     <a href="{{url('electronic')}}">Electronic</a>
                     <a href="{{url('Jewellery')}}">Jewellery</a>
                  </div>
                  <span class="toggle_icon" onclick="openNav()"><img src="{{asset('front/images/toggle-icon.png')}}"></span>
                  <div class="dropdown">
                  ...
                  <div class="header_box">
                     <div class="lang_box ">
                        ...
                        <img src="{{asset('front/images/flag-uk.png')}}" alt="flag" class="mr-2 " title="United Kingdom"> English <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                        </a>
                        <div class="dropdown-menu ">
                           <a href="#" class="dropdown-item">
                           <img src="{{asset('front/images/flag-france.png')}}" class="mr-2" alt="flag">
                           French
                           </a>
                        </div>
                     </div>
